...
aftab_data = os.path.join('..','input_data', 'unsorted', 'Animal Health data', 'Paragon.xlsx')
...
df.to_csv(f'{datacheck}/poultry_paragon.csv') #checking if skiprows and header give the desired result
##############
...
ast_poultry['provider']=pd.Series('Paragon',index=ast_poultry.index)


ast_poultry.to_csv(f'{outputloc}/ast_poultry_paragon.csv')